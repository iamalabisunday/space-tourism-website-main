...
export default function Home() {
  return (
    <div className="w-full h-screen my-auto relative bg-primary">
      ...
      <section className="absolute w-full h-screen xl:mx-auto flex xl:justify-center xl:items-center text-white xl:pb-[0rem] pb-[10rem]">
        <article className="xl:max-w-[69.375rem] xl:min-h-[38.5rem] flex xl:flex-col xl:justify-end xl:items-end flex-row justify-center items-center">
          <section className="w-full h-[21.4375rem] flex xl:flex-row xl:justify-end xl:items-end flex-col">
            <div className="w-full xl:grid xl:grid-cols-2 gap-[3rem] flex flex-col justify-center items-center xl:items-start">
              {/* Text Section */}
              <div className="xl:w-full min-h-[21.4375rem] flex flex-col gap-6 xl:align-item:start xl:justify-center mx-[1.5rem]">
                ...
                <p className="xl:max-w-full lg:max-w-[58%] mx-auto font-barlow text-[0.9375rem] md:text-[1.125rem] leading-[1.8] font-[200] text-secondaryBlue flex justify-center items-center text-center">
              ...
              {/* Explore Section */}
              <div className="xl:w-full flex justify-end items-center">
                <NavLink
                  to="/destination"
