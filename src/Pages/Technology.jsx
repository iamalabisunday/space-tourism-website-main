  ...
  return (
    ...
    >
      <div className="w-full flex flex-col min-h-screen mx-auto lg:justify-start justify-start items-center">
        ...
        <section className="w-full lg:px-[0rem] md:px-[0rem] lg:w-[69.375rem] text-white flex flex-col gap-[0rem] md:gap-[1.5rem] justify-center items-center md:my-[2rem] my-[1rem]">
          {/* Heading text */}
          ...
          <div className="lg:min-w-[69.4rem] lg:max-h-[40rem] md:h-full lg:min-h-[43.8rem] mt-[4rem] md:mt-[0rem] flex flex-col-reverse lg:justify-center md:items-center justify-start items-start lg:gap-[1.5rem] lg:py-[3.5rem] lg:grid lg:grid-cols-2 md:w-full">
            ...
            <section className="lg:min-w-[33.7rem] flex flex-col lg:justify-center lg:items-center ">
              ...
              <div className="w-full h-full lg:min-h-[38.4rem] min-h-[17.4rem] flex flex-col md:justify-center justify-start lg:items-center items-start pt-[2.5rem] lg:pt-[0rem]">
                <div className="flex flex-col lg:flex-row gap-[0.7rem] lg:gap-[0.3rem] lg:w-full md:w-full font-bellefair font-[300] text-center lg:text-start justify-center items-center">
                  {/* Navigation Section */}
                  <nav>
                    <ul className="flex lg:flex-col flex-row justify-between md:gap-[2rem] lg:gap-[0.5rem] gap-[1rem]">
                      <li>
                        <NavLink to="launch">
                          <div className="space lg:w-[5rem] lg:h-[5rem] md:w-[3.5rem] md:h-[3.5rem] rounded-full border-1 border-[#ffffff63] flex items-center justify-center md:text-[2rem] font-bellefair font-[300] text-white text-[1.125rem] w-[2.5rem] h-[2.5rem]">
                            <p>1</p>
                          </div>
                        </NavLink>
                      </li>
                      <li>
                        <NavLink to="spaceport">
                          <div className="space lg:w-[5rem] lg:h-[5rem] md:w-[3.5rem] md:h-[3.5rem] rounded-full border-1 border-[#ffffff63] flex items-center justify-center md:text-[2rem] font-bellefair font-[300] text-[1.125rem] w-[2.5rem] h-[2.5rem]">
                            <p>2</p>
                          </div>
                        </NavLink>
                      </li>
