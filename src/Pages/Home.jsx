...
export default function Home() {
  return (
    <div
      className="w-full lg:min-h-screen lg:py-[10rem] min-h-screen justify-center items-center lg:bg-[url(/home/background-home-desktop.jpg))] md:bg-[url(/home/background-home-tablet.jpg)] 
